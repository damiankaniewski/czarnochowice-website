    ...
    >
      ...
      <div className="flex w-full h-full flex-col p-10">
        <div className="flex w-full flex-col md:flex-row justify-center items-start h-full">
          <div className="w-full h-full md:w-1/4 flex flex-col text-green4 justify-center items-center px-4 space-y-3">
          ...
          <div className="w-full md:w-1/4 flex flex-col text-green4 justify-center items-center px-4 space-y-3 pt-5">
