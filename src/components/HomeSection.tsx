...
export default function Home() {
  return (
    <section
      id="home"
      className="flex justify-center items-center w-full h-screen flex-col relative z-20 bg-[linear-gradient(0deg,rgba(0,0,0,0)_90%,rgba(0,0,0,0.4)_100%)] bg-black/25"
    >
      <p
